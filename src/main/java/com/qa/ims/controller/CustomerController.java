...
public class CustomerController implements CrudController<Customer>{
	...
	public Customer update() {
		LOGGER.info("Please summon the ID of the customer you would like to update");
		...
		LOGGER.info("Customer Updated and Re-Summoned");
		return customer;
	}
	...
	@Override
	public void delete() {
		LOGGER.info("Please enter the ID of the customer you would like to Banish");
		Long id = Long.valueOf(getInput());
		customerService.delete(id);
		LOGGER.info("Cutsomer Banished");
	}

...
public class CustomerTest {
	...
	@Before
	public void setUp() {
		customer = new Customer(7L, "Dan", "Reed");
		other = new Customer(7L, "Dan", "Reed");
	}
	...
	public void createCustomerWithId() {
		assertEquals(7L, customer.getId(), 7);
		assertEquals("Dan", customer.getFirstName());
		assertEquals("Reed", customer.getSurname());
	}
	...
	public void otherSurnameDifferent() {
		other.setSurname("The Dragon Slayer");
		assertFalse(customer.equals(other));
	}
	
	@Test
	public void constructorWithoutId() {
		Customer customer = new Customer("Dan", "Reed");
		assertNull(customer.getId());
		assertNotNull(customer.getFirstName());
		assertNotNull(customer.getSurname());
	}
	...
	public void toStringTest() {
		String toString = "ID: 7 || First Name: Dan || Surname: Reed";
